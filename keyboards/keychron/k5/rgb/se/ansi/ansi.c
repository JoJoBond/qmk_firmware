...
led_config_t g_led_config = {
  {
    ...
    {  62,  63,  64,  65,  66,  67,  68,  69,  70,  71,  72,  73,  74,  75,  XX,  XX,  XX,  76,  77,  78,  XX },
    {  79,  XX,  80,  81,  82,  83,  84,  85,  86,  87,  88,  89,  XX,  90,  XX,  91,  XX,  92,  93,  94,  95 },
    {  96,  97,  98,  XX,  XX,  XX,  99,  XX,  XX,  XX,  100, 101, 102, 103, 104, 105, 106, XX,  107, 108, XX }
  }, {
      { 1 *12, 0  },                { 3 *12, 0  }, { 4 *12, 0  }, { 5 *12, 0  }, { 6 *12, 0  }, { 7 *12, 0  }, { 8 *12, 0  }, { 9 *12, 0  }, { 10*12, 0  }, { 11*12, 0  }, { 12*12, 0  }, { 13*12, 0  }, { 14*12, 0  }, { 15*12, 0  }, { 16*12, 0  }, { 17*12, 0  }, { 18*12, 0  }, { 19*12, 0  }, { 20*12, 0  }, { 21*12, 0  },
